...
class Login extends CI_Controller {
    ...
    public function fblogin(){
        ...
        $fb = new Facebook\Facebook([
              'app_id' => '1102635696803282',
              'app_secret' => '840931f4f2b3618e7dd6ea6f2a1014fc',
        ...
        $loginUrl = $helper->getLoginUrl('http://localhost/ranking/login/fbcallback', $permissions);
    ...
    function fbcallback(){
        ...
        $response = $fb->get('/GuarulhosGRU?feed?fields=likes.limit(1).summary(true)',$accessToken);
    ...
    function getlikes(){
        ...
        try {
          // Get the Facebook\GraphNodes\GraphUser object for the current user.
          // If you provided a 'default_access_token', the '{access-token}' is optional.
          $response = $fb->get('/9gag?feed', $accessToken);
         // print_r($response);
        } catch(Facebook\Exceptions\FacebookResponseException $e) {
          // When Graph returns an error
          echo 'ERROR: Graph ' . $e->getMessage();
